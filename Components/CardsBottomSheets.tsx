...
interface CardsBottomSheetsProps {
  isVisible: boolean;
  onClose: () => void;
}

export default function CardsBottomSheets({ isVisible, onClose }: CardsBottomSheetsProps) {
